...
namespace ConsoleAppWorkerWithExcelDoc
{
    class Program
    {
        /*Программа для работы с таблицей Excel тестовое задание для компаний Акелон*/
        ...
        static void Main(string[] args)
        {
            ...
            //Путь по которому все тестировал
            ...
            //Обрабатываем самые вероятные исключения
            catch (System.IO.FileNotFoundException ex)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Файл не найден по данному пути!");
            }
            catch (Exception ex)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Ошибка при работе программы: " + ex.Message.ToString());
            }
        }
    }
}